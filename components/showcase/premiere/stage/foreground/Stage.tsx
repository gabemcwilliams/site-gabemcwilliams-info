...
const ASSETS = {
    ...
    emblem: '/assets/showcase/premiere/emblem/stage_arch_emblem_base.svg',
    emblemHighlighted: '/assets/showcase/premiere/emblem/stage_arch_emblem_highlighted.svg',
...
function computeEmblemStyle(vw: number): { top: string; width: string } {
    if (vw < BP_SMALL) return {top: '5%', width: '2%'};
    if (vw <= BP_LARGE) return {top: '20.2%', width: '2.8%'};
    return {top: '19.8%', width: '1.5%'};
}
